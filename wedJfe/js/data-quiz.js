...
window.QUIZ_DATA = [
  {
    "id": "t001",
    "source": "test",
    "question": "A process is waiting for data from a disk drive before continuing execution. Which state is the process most likely in?",
    "options": [
      "Terminated",
      "Waiting",
      "Running",
  ...
  },
  {
    "id": "t002",
    "source": "test",
    "question": "A software development team wants to distribute software while allowing users to view, modify, and redistribute the source code.",
    "options": [
      "0.9801",
      "Open-source License (Giấy phép mã nguồn mở - Open-source License - là loại giấy phép đặc trưng cho phép cộng đồng người dùng có quyền tự do truy cập, xem, chỉnh sửa và phân phối lại mã nguồn của phần mềm đó).",
  ...
  },
  {
    ...
    "options": [
      ...
      "Reduce user errors, improve usability",
  ...
  },
  {
    "id": "t005",
    "source": "test",
    "question": "A compiler translates a source program containing 20,000 lines of code. Which statement best describes the compilation process?",
    "options": [
      "Degraded quality, not necessarily fatal",
  ...
  },
  {
    "id": "t008",
    "source": "test",
    "question": "Which OS management function is primarily responsible for deciding which process receives CPU time?",
    "options": [
      "Yes",
      "Process Management (Quản lý tiến trình là chức năng cốt lõi của Hệ điều hành chịu trách nhiệm lên lịch (scheduling) và quyết định tiến trình nào sẽ được cấp phát thời gian sử dụng CPU).",
      "O(1)",
  ...
  },
  {
    "id": "t010",
    "source": "test",
    "question": "Which generation of computers introduced VLSI technology?",
    "options": [
      "Hard disk / SSD / ROM / flash",
      "4th generation (Máy tính thế hệ thứ 4 đánh dấu sự ra đời của công nghệ vi mạch tích hợp mật độ rất cao - VLSI, cho phép thu nhỏ hàng ngàn transistor vào một chip vi xử lý duy nhất).",
      "File management",
      "Batch processing"
    ],
    "correctIndex": 1,
  ...
  },
  {
    "id": "t011",
    "source": "test",
    "question": "Why is user-friendly interface design important?",
    "options": [
      "Information systems strategy",
      "DELETE rows; DROP structure+data",
  ...
  },
  {
    "id": "t012",
    "source": "test",
    "question": "Which of the following devices was mainly used as the logic gate in first-generation computers?",
    "options": [
      "Sequential phases",
      "Needed page not in RAM",
      "Vacuum tube (Máy tính thế hệ đầu tiên sử dụng các ống/đèn chân không - Vacuum tubes - làm các cổng logic và bộ khuếch đại điện tử để xử lý tín hiệu).",
      "128"
    ],
    "correctIndex": 2,
  ...
  },
  {
    "id": "t013",
    "source": "test",
    "question": "Which type of software acts as an intermediary between application software and the operating system?",
    "options": [
      "All are correct",
      "Expression of work / software code as work",
      "Middleware (Phần mềm trung gian - Middleware - hoạt động như một cầu nối/trung gian giữa các ứng dụng và hệ điều hành hoặc giữa các ứng dụng với nhau).",
  ...
  },
  {
    "id": "t014",
    "source": "test",
    "question": "Which statement correctly describes the advantage of an interpreter compared with a compiler?",
    "options": [
      "It eliminates syntax checking",
      "It produces a faster executable program",
      "It creates object code before execution",
  ...
  },
  {
    "id": "t015",
    "source": "test",
    "question": "Which type of processing system executes jobs collectively without user interaction?",
    "options": [
  ...
  },
  {
    "id": "t016",
    "source": "test",
    "question": "Two modules have reliabilities 0.95 and 0.90 in a series system. What is the system reliability?",
    "options": [
      "0.950",
      "0.905",
      "0.855",
  ...
  },
  {
    "id": "t017",
    "source": "test",
    "question": "Which programming language is closest to machine language and uses mnemonic instructions?",
    "options": [
  ...
  },
  {
    "id": "t018",
    "source": "test",
    "question": "What is the smallest unit of data representation in computers?",
    "options": [
      "Nibble",
      "Bit",
      "Byte",
  ...
  },
  {
    "id": "t019",
    "source": "test",
    "question": "What is the characteristic of auxiliary storage?",
    "options": [
      "Moving visual content",
      "It has non-volatile characteristics (Bộ nhớ phụ / lưu trữ ngoài như ổ cứng HDD, SSD có đặc tính \"non-volatile\", tức là bộ nhớ bất biến, không bị mất dữ liệu khi tắt nguồn điện).",
      "EV/PV",
  ...
  },
  {
    "id": "t020",
    "source": "test",
    "question": "Which of the following character codes is internationally standardized for multilingual text representation?",
    "options": [
      "Extract Transform Load",
      "Unicode (Unicode là bộ mã chuẩn quốc tế được thiết kế để có thể biểu diễn văn bản của hầu hết các ngôn ngữ trên thế giới).",
      "Common key cryptography is safe for communication with multiple parties, even when the same encryption key is used.",
  ...
  },
  {
    "id": "t022",
    "source": "test",
    "question": "Which of the following software is typically stored in ROM and remains available even when power is turned off?",
    "options": [
      "Utility software",
      "Interpreter",
  ...
  },
  {
    "id": "t023",
    "source": "test",
    "question": "Which of the following is performed in the Plan phase of a PDCA model that is applied to any ISMS process?",
    "options": [
      "Risk assessment of information assets",
      "Implementation of improvement measures",
      "Management of operational status",
  ...
  },
  {
    "id": "t024",
    "source": "test",
    "question": "When a file of 10^6 bytes is transmitted by using a 64 kbps line, approximately how long (in seconds) does it take to transfer the file? *(phần cuối bị khuất, có xuất hiện cụm)* 80%.",
    "options": [
      "157",
      "125",
      "100",
  ...
  },
  {
    "id": "t026",
    "source": "test",
    "question": "Which of the following is an appropriate description of cryptography?",
    "options": [
      "Public key cryptography requires that the encryption key be privately distributed to the communicating party.",
  ...
  },
  {
    "id": "t027",
    "source": "test",
    "question": "An 8-bit two's complement value is 11101010. What is its decimal value?",
    "options": [
      "106",
      "234",
      "-21",
  ...
  },
  {
    "id": "t028",
    "source": "test",
    "question": "Which of the following is an objective of a software developer in attaching a digital signature to software when software is released on the Internet?",
    "options": [
      "To assure that the content of the software is not changed illegally",
      "To show that the software copyright lies with the developer",
  ...
  },
  {
    "id": "t029",
    "source": "test",
    "question": "Thuật toán nào thuộc nhóm Divide and Conquer?",
    "options": [
      "Selection Sort",
      "Bubble Sort",
      "Insertion Sort",
  ...
  },
  {
    "id": "t030",
    "source": "test",
    "question": "Which of the following is biometric authentication that uses information which can be obtained from the human eye?",
    "options": [
  ...
  },
  {
    "id": "t031",
    "source": "test",
    "question": "A company wants software that can be legally copied and used without purchasing a license fee. Which category is most appropriate?",
    "options": [
  ...
  },
  {
    "id": "t032",
    "source": "test",
    "question": "Which of the following is an appropriate description of JPCERT/CC?",
    "options": [
      "It is a project to investigate appropriate implementation methods and operational methods for cryptography.",
      "It is a security center under the jurisdiction of the Information-technology Promotion Agency, Japan.",
      "It is an information security center that is established in the Cabinet Secretariat of Japan.",
  ...
  },
  {
    "id": "t033",
    "source": "test",
    "question": "What is availability in system reliability evaluation?",
    "options": [
      "The size of auxiliary storage",
      "The speed of data entry",
      "The probability that a system is usable when needed",
  ...
  },
  {
    "id": "t034",
    "source": "test",
    "question": "Which component combines multiple object modules into a single executable program?",
    "options": [
      "Assembler",
      "Loader",
      "Linker",
  ...
  },
  {
    "id": "t035",
    "source": "test",
    "question": "Which of the following is an appropriate description of WPA? (Từ cuối hơi mờ, dựa vào đáp án có thể là WPA hoặc WAF)",
    "options": [
      "It is a method for one-to-one conversion of an internal address to an external address.",
      "It is software that blocks an attack against vulnerabilities in the Web application.",
  ...
  },
  {
    "id": "t038",
    "source": "test",
    "question": "Which processing system is most appropriate for payroll calculations performed once a month?",
    "options": [
  ...
  },
  {
    ...
    "options": [
      "The loss of an encryption key can be prevented.",
      "The attack that obstructs mail service can be prevented.",
      "The leakage of e-mail content can be prevented.",
  ...
  },
  {
    "id": "t040",
    "source": "test",
    "question": "Which of the following is an appropriate description of risk assessment?",
    "options": [
      "Since the purpose of risk analysis is to determine the value of losses resulting from the materialization of risk, an organization should consider measures for prioritized risks with the highest loss value.",
      "Since risk analysis is for the purpose of preventing future losses, an organization should avoid referencing data that is collected from a similar past project.",
      "Until all measures to risks that are evaluated through risk analyses are completed, an organization should avoid implementing repeated risk assessments.",
  ...
  },
  {
    "id": "t041",
    "source": "test",
    "question": "Which type of processing system is suitable for airline reservation systems requiring immediate responses?",
    "options": [
  ...
  },
  {
    "id": "t042",
    "source": "test",
    "question": "Cấu trúc dữ liệu nào phù hợp nhất để xử lý lời gọi hàm đệ quy?",
    "options": [
      "Stack",
      "Array",
      "Linked List",
  ...
  },
  {
    "id": "t043",
    "source": "test",
    "question": "Which file organization method stores records in the order they are received, without any sorting?",
    "options": [
      "Heap file",
      "Relative file",
      "Sequential file",
  ...
  },
  {
    "id": "t044",
    "source": "test",
    "question": "Which processing system concentrates all processing tasks on one central computer?",
    "options": [
  ...
  },
  {
    "id": "t045",
    "source": "test",
    "question": "Which of the following is an appropriate description of the role of a reverse proxy?",
    "options": [
      "It detects intrusion into a network.",
  ...
  },
  {
    "id": "t046",
    "source": "test",
    "question": "Which of the following is an appropriate explanation of OP25B?",
    "options": [
      "Performing port number-based filtering of e-mail which is sent from the internal network to an external mail server.",
      "Restricting access to websites from the internal network by filtering content.",
      "Authenticating the source domain of the e-mail by recording signature information in e-mail headers.",
  ...
  },
  {
    "id": "t047",
    "source": "test",
    "question": "Which multimedia element represents moving visual content?",
    "options": [
      "Graphics",
      "Audio",
      "Text",
  ...
  },
  {
    "id": "t048",
    "source": "test",
    "question": "Thuật toán nào có ý tưởng đẩy phần tử lớn nhất về cuối dãy sau mỗi lượt quét?",
    "options": [
      "Selection Sort",
      "Bubble Sort",
      "Merge Sort",
  ...
  },
  {
    "id": "t049",
    "source": "test",
    "question": "What is the value of hexadecimal number A in decimal notation?",
    "options": [
      "10",
      "11",
      "12"
  ...
  },
  {
    "id": "t050",
    "source": "test",
    "question": "What is response time in system evaluation?",
    "options": [
      "The lifetime of a storage device",
      "The time required to repair hardware",
  ...
  },
  {
    "id": "t051",
    "source": "test",
    "question": "Which of the following is a secure protocol that combines an authentication function between a client and a server with an encryption function for communication data?",
    "options": [
      "OAuth",
      "EAP",
      "SSL",
  ...
  },
  {
    "id": "t052",
    "source": "test",
    "question": "Which of the following is an appropriate description concerning antivirus software?",
    "options": [
      "In the method of detecting a virus by identifying unauthorized behavior, the name of the virus can be identified from the behavior characteristics.",
      "A signature file for antivirus software is a database that contains the first 16 bytes or 32 bytes of the code of each virus.",
      "If the size of a file that is infected by a virus is the same as the size before the infection, the file can be restored to its pre-infection state by removing the virus.",
  ...
  },
  {
    "id": "t053",
    "source": "test",
    "question": "What is the main advantage of semiconductor memory over magnetic disks?",
    "options": [
      "Faster access speed",
      "Consumes more power",
  ...
  },
  {
    "id": "t054",
    "source": "test",
    "question": "Thuật toán nào không yêu cầu dữ liệu được sắp xếp trước?",
    "options": [
      "Merge Sort",
      "Quick Sort",
      "Binary Search",
  ...
  },
  {
    "id": "t055",
    "source": "test",
    "question": "Which of the following is an appropriate description of information security policy?",
    "options": [
      ...
      "A company's top management should externally disclose information system vulnerabilities that are factors behind the development of a security policy.",
  ...
  },
  {
    "id": "t056",
    "source": "test",
    "question": "Which of the following best describes an assembler?",
    "options": [
  ...
  },
  {
    "id": "t057",
    "source": "test",
    "question": "When an internal user of a company forgets the password, which of the following is an appropriate action a security administrator should take after the identity of the user is verified?",
    "options": [
      "Resetting the password, and having the user set a new password",
  ...
  },
  {
    "id": "t059",
    "source": "test",
    "question": "A database file contains one million records. Users frequently retrieve records using a unique customer ID. Which file organization method provides the fastest access?",
    "options": [
      "Direct file",
      "Heap file",
      "Sequential file",
  ...
  },
  {
    "id": "t060",
    "source": "test",
    "question": "According to ISO/IEC 27001 (JIS Q 27001), which of the following is the definition of availability in information security?",
    "options": [
      "Ensuring that information is not disclosed to third parties",
  ...
  },
  {
    "id": "t061",
    "source": "test",
    "question": "Which of the following is an appropriate explanation of TDM that is one of the multiplexing techniques?",
    "options": [
      "It is a multiplexing technique that is used to assign a code to each user.",
      "It is a multiplexing technique that is used to change the frequency band in use.",
  ...
  },
  {
    "id": "t062",
    "source": "test",
    "question": "Among the descriptions concerning devices that constitute a network, which of the following is an explanation concerning the CCU (Communication Control Unit)?",
    "options": [
      "It performs conversion from a digital signal to an analog signal, and vice versa.",
      "It dials the telephone number of the terminal in order to call the terminal.",
  ...
  },
  {
    "id": "t063",
    "source": "test",
    "question": "Which of the following is an appropriate description of WPA?",
    "options": [
      "It is a method for one-to-one conversion of an internal address to an external address.",
      "It is software that blocks an attack against vulnerabilities in the Web application.",
      "It is a method that integrates and centrally manages multiple different security functions.",
  ...
  },
  {
    "id": "t064",
    "source": "test",
    "question": "Which of the following is the action that corresponds to social engineering?",
    "options": [
      "Externally controlling a virus-infected computer",
  ...
  },
  {
    "id": "t065",
    "source": "test",
    "question": "What is the purpose of human interface technology?",
    "options": [
  ...
  },
  {
    "id": "t067",
    "source": "test",
    "question": "A software system must support multiple users accessing files simultaneously while preventing... (phần sau bị khuất)",
    "options": [
      "Software Licensing",
      "Language Processing",
      "Memory Management",
  ...
  },
  {
    "id": "q003",
    "source": "bank300",
    "question": "Which generation introduced VLSI?",
    "options": [
      "4th generation",
  ...
  },
  {
    "id": "q004",
    "source": "bank300",
    "question": "First-generation logic device?",
    "options": [
      "Assembly",
      "Ready",
      "Batch processing",
  ...
  },
  {
    "id": "q005",
    "source": "bank300",
    "question": "Non-volatile storage example?",
    "options": [
  ...
  },
  {
    "id": "q007",
    "source": "bank300",
    "question": "Main memory is typically which type?",
    "options": [
      "Pointer updates, no full shift",
      "IT governance best practices framework",
      "Assembly",
      "RAM (DRAM), volatile"
    ],
    "correctIndex": 3,
  ...
  },
  {
    "id": "q008",
    "source": "bank300",
    "question": "Cache is usually implemented with?",
    "options": [
  ...
  },
  {
    "id": "q009",
    "source": "bank300",
    "question": "Hexadecimal digit A in decimal?",
    "options": [
      "It is a method for one-to-one conversion of an internal address to an external address.",
      "POP/IMAP",
  ...
  },
  {
    "id": "q010",
    "source": "bank300",
    "question": "Number system using digits 0-7?",
    "options": [
      "RAM (DRAM), volatile",
      "Octal",
      "Wi-Fi",
  ...
  },
  {
    "id": "q011",
    "source": "bank300",
    "question": "8-bit two's complement 11101010 equals?",
    "options": [
      "Reduce user errors, improve usability",
      "Optical wavelengths",
      "Loader",
  ...
  },
  {
    "id": "q012",
    "source": "bank300",
    "question": "Two's complement of negative: method?",
    "options": [
      "It is a method for one-to-one conversion of an internal address to an external address.",
      "DROP TABLE",
      "Invert bits then +1",
  ...
  },
  {
    "id": "q013",
    "source": "bank300",
    "question": "Range of n-bit 2's complement?",
    "options": [
  ...
  },
  {
    "id": "q014",
    "source": "bank300",
    "question": "International multilingual character code?",
    "options": [
      "Mirroring",
      "128",
      "Unicode",
  ...
  },
  {
    "id": "q016",
    "source": "bank300",
    "question": "Which is a peripheral device?",
    "options": [
      "Work completed per unit time",
      "Seek + rotational latency + transfer",
  ...
  },
  {
    "id": "q017",
    "source": "bank300",
    "question": "Register is inside CPU: peripheral?",
    "options": [
  ...
  },
  {
    "id": "q018",
    "source": "bank300",
    "question": "Auxiliary storage characteristic?",
    "options": [
      "Tape file",
      "APOP",
      "Non-volatile",
  ...
  },
  {
    "id": "q019",
    "source": "bank300",
    "question": "Advantage of semiconductor memory vs magnetic disk?",
    "options": [
      "Faster access",
  ...
  },
  {
    "id": "q020",
    "source": "bank300",
    "question": "Access time of disk includes?",
    "options": [
  ...
  },
  {
    "id": "q023",
    "source": "bank300",
    "question": "Instruction cycle order?",
    "options": [
      "Fetch -> Decode -> Execute",
      "Linker",
      "Network layer, interconnects networks",
  ...
  },
  {
    "id": "q025",
    "source": "bank300",
    "question": "Pipeline hazard types?",
    "options": [
      "Structural, data, control",
      "Reset password; user sets new one",
      "POP/IMAP",
  ...
  },
  {
    "id": "q027",
    "source": "bank300",
    "question": "1 KB in traditional binary memory?",
    "options": [
      "Slower",
  ...
  },
  {
    "id": "q028",
    "source": "bank300",
    "question": "Information amount with n bits?",
    "options": [
      "Stack",
      "Left-Right-Node",
  ...
  },
  {
    "id": "q031",
    "source": "bank300",
    "question": "Jobs executed collectively without user interaction?",
    "options": [
      "Batch processing",
  ...
  },
  {
    "id": "q032",
    "source": "bank300",
    "question": "Payroll once a month best system?",
    "options": [
      "12",
  ...
  },
  {
    "id": "q033",
    "source": "bank300",
    "question": "Airline reservation immediate response?",
    "options": [
      "Real-time processing",
      "No partial dependency on key",
  ...
  },
  {
    "id": "q034",
    "source": "bank300",
    "question": "Hard real-time example idea?",
    "options": [
      "Airbag / life-critical control",
      "Compare with best practice/competitors",
      "Invert bits then +1",
  ...
  },
  {
    "id": "q035",
    "source": "bank300",
    "question": "All processing on one central computer?",
    "options": [
  ...
  },
  {
    "id": "q036",
    "source": "bank300",
    "question": "Reliability series R=0.95 and 0.90?",
    "options": [
      "0.855",
      "Seek + rotational latency + transfer",
      "Moderator-led formal review",
  ...
  },
  {
    "id": "q037",
    "source": "bank300",
    "question": "Parallel reliability formula idea?",
    "options": [
      "Batch job completion latency",
      "Tape file",
      "1-(1-R1)(1-R2)...",
      "Utility software"
    ],
  ...
  },
  {
    "id": "q042",
    "source": "bank300",
    "question": "Purpose of interface design?",
    "options": [
      "Logs, audits, alerts",
      "Add resources to shorten duration (cost↑)",
      "The amount of electricity consumed",
  ...
  },
  {
    "id": "q044",
    "source": "bank300",
    "question": "Purpose of human interface technology?",
    "options": [
  ...
  },
  {
    "id": "q045",
    "source": "bank300",
    "question": "Video multimedia means?",
    "options": [
      "234",
  ...
  },
  {
    "id": "q048",
    "source": "bank300",
    "question": "Intermediary between apps and OS?",
    "options": [
      "Audio",
      "4th generation",
  ...
  },
  {
    "id": "q049",
    "source": "bank300",
    "question": "Compiler translates how?",
    "options": [
      "Merge Sort",
      "15",
      "Node-Left-Right",
  ...
  },
  {
    "id": "q050",
    "source": "bank300",
    "question": "Interpreter advantage vs compiler?",
    "options": [
      "Smallest module/unit",
  ...
  },
  {
    "id": "q051",
    "source": "bank300",
    "question": "Language closest to machine with mnemonics?",
    "options": [
      "It is a security center under the jurisdiction of the Information-technology Promotion Agency, Japan.",
      "Choose rows by condition",
      "Name <-> IP",
  ...
  },
  {
    "id": "q053",
    "source": "bank300",
    "question": "Combines object modules into executable?",
    "options": [
      "O(log N)",
      "Network layer, interconnects networks",
      "Linker",
  ...
  },
  {
    "id": "q054",
    "source": "bank300",
    "question": "Loads program into memory?",
    "options": [
      "Technical security measure",
      "Interactive processing system",
      "Loader",
  ...
  },
  {
    "id": "q055",
    "source": "bank300",
    "question": "Software in ROM after power off?",
    "options": [
      "It is a method for one-to-one conversion of an internal address to an external address.",
      "Firmware",
  ...
  },
  {
    "id": "q056",
    "source": "bank300",
    "question": "Allow view/modify/redistribute source?",
    "options": [
      "Reliable connection-oriented vs lightweight connectionless",
      "No transitive dependency",
      "Open-source license",
      "EV/AC"
    ],
  ...
  },
  {
    "id": "q057",
    "source": "bank300",
    "question": "Free use without fee legally for OSS category?",
    "options": [
      "O(log N)",
  ...
  },
  {
    "id": "q058",
    "source": "bank300",
    "question": "OS function deciding CPU time for process?",
    "options": [
      "Process management / scheduling",
      "Creator + peers find errors early",
      "Support/control multiple projects",
  ...
  },
  {
    "id": "q059",
    "source": "bank300",
    "question": "Process waiting for disk I/O state?",
    "options": [
      "Switch/hub",
      "Waiting / Blocked",
      "To restrict use of the software to specified users",
  ...
  },
  {
    "id": "q060",
    "source": "bank300",
    "question": "Process runnable waiting CPU?",
    "options": [
      "Detect illegal modification / integrity",
      "Ready",
      "Block outbound SMTP port 25 from internal hosts",
      "Decrypting the encrypted password that is managed by the security administrator, and informing the user by e-mail"
    ],
  ...
  },
  {
    "id": "q061",
    "source": "bank300",
    "question": "Scheduling that may starve long jobs?",
    "options": [
      "Palm authentication",
  ...
  },
  {
    "id": "q063",
    "source": "bank300",
    "question": "Coffman conditions count?",
    "options": [
      "Expression of work / software code as work",
      "Device Management",
      "4",
  ...
  },
  {
    "id": "q064",
    "source": "bank300",
    "question": "Eliminate which condition to prevent deadlock (common)?",
    "options": [
      "Selection Sort",
      "Direct file (hash/relative)",
  ...
  },
  {
    "id": "q066",
    "source": "bank300",
    "question": "Microkernel vs monolithic?",
    "options": [
      "Role-Based Access Control",
      "AES",
      "Platform as a Service",
  ...
  },
  {
    "id": "q067",
    "source": "bank300",
    "question": "Virtual memory page fault?",
    "options": [
      "~157 seconds",
      "Needed page not in RAM",
      "IP to MAC",
  ...
  },
  {
    "id": "q070",
    "source": "bank300",
    "question": "File organization fastest by unique ID?",
    "options": [
      "Lower speed",
      "Starvation / unfair long wait (improves fairness)",
  ...
  },
  {
    "id": "q071",
    "source": "bank300",
    "question": "File stores in arrival order unsorted?",
    "options": [
      "Heap file",
  ...
  },
  {
    "id": "q072",
    "source": "bank300",
    "question": "Sequential file good for?",
    "options": [
      "One-way fingerprint; integrity check",
      "32",
      "Known viruses with names",
  ...
  },
  {
    "id": "q074",
    "source": "bank300",
    "question": "OS multi-user concurrent files function?",
    "options": [
      "To restrict use of the software to specified users",
      "0.99",
      "Backup system already running",
  ...
  },
  {
    "id": "q075",
    "source": "bank300",
    "question": "SQL remove table definition and data?",
    "options": [
      "0.81",
      "DROP TABLE",
      "Wireless LAN encryption/security method",
  ...
  },
  {
    ...
    "options": [
      "Shared medium / collision / cable fault impact",
      "Referential integrity",
      "Invert bits then +1",
      "Analytical, historical, non-volatile integrated store"
    ],
  ...
  },
  {
    "id": "q082",
    "source": "bank300",
    "question": "ACID D means?",
    "options": [
      "Improve human-computer interaction",
      "State org behavior/judgment criteria for security",
      "Work Breakdown Structure hierarchy of work",
      "Durability"
    ],
    "correctIndex": 3,
  ...
  },
  {
    "id": "q083",
    "source": "bank300",
    "question": "Selection relational op?",
    "options": [
      "Work Breakdown Structure hierarchy of work",
      "Choose rows by condition",
      "Open-source license",
  ...
  },
  {
    "id": "q084",
    "source": "bank300",
    "question": "Projection relational op?",
    "options": [
  ...
  },
  {
    "id": "q086",
    "source": "bank300",
    "question": "Data warehouse vs OLTP?",
    "options": [
      "The sending log of the mail server can be protected from falsification.",
      "Analytical, historical, non-volatile integrated store",
      "Receives client requests on behalf of server",
  ...
  },
  {
    "id": "q089",
    "source": "bank300",
    "question": "OSI layer for end-to-end reliability?",
    "options": [
      "Centralized processing",
      "Transport (4)",
      "Compare with best practice/competitors",
  ...
  },
  {
    ...
    "question": "DNS role?",
    "options": [
      "Sends requests on behalf of client",
      "Direct file (hash/relative)",
  ...
  },
  {
    "id": "q095",
    "source": "bank300",
    "question": "TDM explanation?",
    "options": [
      "Multiplex by time slots",
      "It sends an access request, in place of a client, to a server.",
      "0.855",
      "Speed up search"
    ],
  ...
  },
  {
    "id": "q101",
    "source": "bank300",
    "question": "File 10^6 bytes on 64kbps 80% util time?",
    "options": [
      "Node-Left-Right",
      "Stack",
      "1024 bytes",
  ...
  },
  {
    "id": "q102",
    "source": "bank300",
    "question": "Transfer time formula?",
    "options": [
      "Heap file",
      "SJF / priority without aging",
      "Ready",
  ...
  },
  {
    "id": "q110",
    "source": "bank300",
    "question": "CIA Availability definition?",
    "options": [
      "O(n log n)",
      "Firmware",
      "Accessible when required",
  ...
  },
  {
    "id": "q113",
    "source": "bank300",
    "question": "ISMS Plan phase includes?",
    "options": [
      "Risk assessment of assets",
      "Octal",
  ...
  },
  {
    "id": "q115",
    "source": "bank300",
    "question": "Risk assessment proper approach?",
    "options": [
      "Estimate loss & frequency, rank risks",
      "Distributed transaction atomic commit",
      "Mirroring",
  ...
  },
  {
    "id": "q116",
    "source": "bank300",
    "question": "Security policy should?",
    "options": [
      "Utility software",
      "Sequential file",
      "State org behavior/judgment criteria for security",
  ...
  },
  {
    "id": "q117",
    "source": "bank300",
    "question": "Hybrid crypto practical method?",
    "options": [
      "12",
      "BCP for IT services",
      "Cannot deny performed action",
  ...
  },
  {
    "id": "q118",
    "source": "bank300",
    "question": "Public key crypto speed vs symmetric?",
    "options": [
      "-2^(n-1) .. 2^(n-1)-1",
      "Slower",
      "32",
  ...
  },
  {
    "id": "q119",
    "source": "bank300",
    "question": "Public encryption key distribution?",
    "options": [
      "Can be public, not privately required",
      "Align IT with business, manage IT risk/value",
      "0.81",
  ...
  },
  {
    "id": "q120",
    "source": "bank300",
    "question": "Digital signature on released software aims?",
    "options": [
      "Detect illegal modification / integrity",
      "O(1) by index",
  ...
  },
  {
    "id": "q121",
    "source": "bank300",
    "question": "Email encryption effect?",
    "options": [
      "Palm authentication",
      "Prevent content leakage",
  ...
  },
  {
    "id": "q122",
    "source": "bank300",
    "question": "Iris authentication type?",
    "options": [
      "Manual processing system",
      "Detect illegal modification / integrity",
      "No transitive dependency",
  ...
  },
  {
    "id": "q131",
    "source": "bank300",
    "question": "Antivirus signature method good for?",
    "options": [
      "LAN Ethernet cabling",
      "Prioritize vital few (80/20)",
      "Known viruses with names",
  ...
  },
  {
    "id": "q132",
    "source": "bank300",
    "question": "Admin action forgotten password after verify?",
    "options": [
      "1024 bytes",
      "Liabilities + Equity",
      "Reset password; user sets new one",
  ...
  },
  {
    "id": "q133",
    "source": "bank300",
    "question": "Symmetric crypto other name?",
    "options": [
      "1-(1-R1)(1-R2)...",
      "Safe concurrent shared code",
      "I/O transfers without CPU per-byte involvement",
  ...
  },
  {
    "id": "q140",
    "source": "bank300",
    "question": "Best for recursion call handling?",
    "options": [
      "Classic Ethernet",
      "Quick Sort / Merge Sort",
      "Stack",
  ...
  },
  {
    "id": "q141",
    "source": "bank300",
    "question": "Stack: PUSH3 PUSH7 POP PUSH5 PUSH9 POP top?",
    "options": [
      "Less than node",
      "256",
      "Non-volatile",
  ...
  },
  {
    "id": "q142",
    "source": "bank300",
    "question": "Queue: ENQA ENQB DEQ ENQC ENQD DEQ front?",
    "options": [
      "256",
      "Assembly",
      "ROM",
  ...
  },
  {
    "id": "q143",
    "source": "bank300",
    "question": "Singly list traverse from?",
    "options": [
      "Head",
      "O(n^2)",
      "What system does vs quality attributes",
  ...
  },
  {
    "id": "q144",
    "source": "bank300",
    "question": "Insert X between B and C?",
    "options": [
      "B.next=X; X.next=C",
      "-22",
      "Improve human-computer interaction",
  ...
  },
  {
    "id": "q147",
    "source": "bank300",
    "question": "BST inorder of 50,30,70,20,40,60,80?",
    "options": [
      "Shared medium / collision / cable fault impact",
  ...
  },
  {
    "id": "q148",
    "source": "bank300",
    "question": "BST left subtree values?",
    "options": [
      "Less than node",
      "Node-Left-Right",
      "Batch processing",
  ...
  },
  {
    "id": "q149",
    "source": "bank300",
    "question": "Divide and Conquer sort example?",
    "options": [
      "Detect illegal modification / integrity",
      "Airbag / life-critical control",
      "Web security / input output encoding",
  ...
  },
  {
    "id": "q151",
    "source": "bank300",
    "question": "Selection sort first pass on 84 73 28 16 51?",
    "options": [
      "Entity integrity / unique row id",
      "APOP",
      "Atomic values, no repeating groups",
  ...
  },
  {
    "id": "q152",
    "source": "bank300",
    "question": "Linear search needs sorted data?",
    "options": [
      "Availability (power)",
      "No",
      "SJF / priority without aging",
  ...
  },
  {
    "id": "q153",
    "source": "bank300",
    "question": "Binary search needs sorted data?",
    "options": [
      "Yes",
      "Internet layer",
      "Faster access",
  ...
  },
  {
    "id": "q154",
    "source": "bank300",
    "question": "Linear search best comparisons?",
    "options": [
      "Support/control multiple projects",
      "Merge Sort",
      "More jobs/transactions per time",
  ...
  },
  {
    "id": "q155",
    "source": "bank300",
    "question": "Linear search worst complexity?",
    "options": [
  ...
  },
  {
    "id": "q157",
    "source": "bank300",
    "question": "Array access time complexity?",
    "options": [
      "Overlap phases/activities",
      "O(1) by index",
      "Accessible when required",
      "Slower"
    ],
  ...
  },
  {
    "id": "q158",
    "source": "bank300",
    "question": "Linked list insert advantage?",
    "options": [
      "Starvation / unfair long wait (improves fairness)",
      "Pointer updates, no full shift",
      "Left-Right-Node",
  ...
  },
  {
    "id": "q159",
    "source": "bank300",
    "question": "Full binary tree 31 nodes min height (edges)?",
    "options": [
      "4",
      "4th generation",
      "Client requests, server responds",
  ...
  },
  {
    "id": "q172",
    "source": "bank300",
    "question": "PERT critical path float?",
    "options": [
      "The number of network users",
      "0",
  ...
  },
  {
    "id": "q173",
    "source": "bank300",
    "question": "Competitive leader strategy?",
    "options": [
      "High availability hardware",
      "Zero float/slack",
      "Omnidirectional / full market",
  ...
  },
  {
    "id": "q176",
    "source": "bank300",
    "question": "Product life cycle stages?",
    "options": [
      "4th generation",
      "Intro Growth Maturity Decline",
      "0.855",
  ...
  },
  {
    "id": "q190",
    "source": "bank300",
    "question": "Configuration baseline?",
    "options": [
      "POP/IMAP",
      "Anyone interested/affected by project",
      "Multiplex by time slots",
  ...
  },
  {
    "id": "q192",
    "source": "bank300",
    "question": "Project constraints QCD?",
    "options": [
      "Node-Left-Right",
      "Quality Cost Delivery",
      "80 (HTTPS 443)",
  ...
  },
  {
    "id": "q198",
    "source": "bank300",
    "question": "System audit is?",
    "options": [
      "Independent evaluation of IS controls",
      "Approved reference version of CIs",
      "Stack",
      "Fix defects"
    ],
  ...
  },
  {
    "id": "q206",
    "source": "bank300",
    "question": "Outsourcing offshore risk?",
    "options": [
      "Full, differential, incremental",
      "Input unit (keyboard, mouse...)",
      "Integrated enterprise resource management",
  ...
  },
  {
    "id": "q216",
    "source": "bank300",
    "question": "Requirements: functional vs non-functional?",
    "options": [
      "Expression of work / software code as work",
      "Information systems strategy",
      "Yes",
  ...
  },
  {
    "id": "q219",
    "source": "bank300",
    "question": "Corrective maintenance?",
    "options": [
      "Batch sequential processing",
      "Fix defects",
      "Choose columns",
  ...
  },
  {
    "id": "q221",
    "source": "bank300",
    "question": "Perfective maintenance?",
    "options": [
      "O(1)",
      "All are correct",
      "Improve features/performance",
  ...
  },
  {
    "id": "q223",
    "source": "bank300",
    "question": "Project temporary means?",
    "options": [
      "Bit",
  ...
  },
  {
    "id": "q227",
    "source": "bank300",
    "question": "Critical path activities have?",
    "options": [
      "Zero float/slack",
      "Work completed per unit time",
      "Improve features/performance",
  ...
  },
  {
    "id": "q232",
    "source": "bank300",
    "question": "Availability management goal?",
    "options": [
      "All are correct",
      "-22",
      "Ping / error reporting",
  ...
  },
  {
    "id": "q233",
    "source": "bank300",
    "question": "IT service continuity related to?",
    "options": [
      "Ready",
      "BCP for IT services",
      "Meet agreed availability in SLA",
  ...
  },
  {
    "id": "q234",
    "source": "bank300",
    "question": "Preventive control example?",
    "options": [
      "Extract Transform Load",
      "Lower speed",
      "Bit",
  ...
  },
  {
    "id": "q235",
    "source": "bank300",
    "question": "Detective control example?",
    "options": [
      "Omnidirectional / full market",
      "Customer relationship management",
      "Logs, audits, alerts",
  ...
  },
  {
    "id": "q236",
    "source": "bank300",
    "question": "External audit vs internal?",
    "options": [
      "AES",
      "Energy-efficient IT / reduce environmental impact",
      "Outside independent party vs inside org",
  ...
  },
  {
    "id": "q237",
    "source": "bank300",
    "question": "General IT controls vs application controls?",
    "options": [
      "Energy-efficient IT / reduce environmental impact",
      "Accurate and complete",
      "Environment-wide vs app-specific",
  ...
  },
  {
    "id": "q238",
    "source": "bank300",
    "question": "Series reliabilities 0.9 and 0.9?",
    "options": [
      "Dynamic IP assignment",
      "0.81",
      "Tape file",
  ...
  },
  {
    "id": "q240",
    "source": "bank300",
    "question": "Parallel two 0.9 modules approx R?",
    "options": [
      "O(1)",
      "Ensuring that a user of an information system is the correctly authorized user",
      "0.99",
  ...
  },
  {
    "id": "q241",
    "source": "bank300",
    "question": "MTBF=99 MTTR=1 availability?",
    "options": [
      "Interactive processing system",
      "0.99 / 99%",
      "10",
  ...
  },
  {
    "id": "q244",
    "source": "bank300",
    "question": "16-bit patterns count?",
    "options": [
      "65536",
      "Split frequency bands",
      "Reset password; user sets new one",
  ...
  },
  {
    "id": "q249",
    "source": "bank300",
    "question": "Stack empty PUSH1 PUSH2 POP result top?",
    "options": [
      "1",
      "Overlap phases/activities",
      "Client requests, server responds",
  ...
  },
  {
    "id": "q250",
    "source": "bank300",
    "question": "Queue empty ENQ1 ENQ2 DEQ front?",
    "options": [
      "Airbag / life-critical control",
      "2",
      "Omnidirectional / full market",
  ...
  },
  {
    "id": "q251",
    "source": "bank300",
    "question": "Best OS for many short interactive jobs fairness?",
    "options": [
      "Round Robin",
      "Authorization before action",
      "4th generation",
  ...
  },
  {
    "id": "q252",
    "source": "bank300",
    "question": "Starvation risk algorithm?",
    "options": [
      "SJF",
      "Availability (power)",
      "Head",
  ...
  },
  {
    "id": "q253",
    "source": "bank300",
    "question": "Process blocked on keyboard input state?",
    "options": [
      "Waiting/Blocked",
      "Decrypting the encrypted password that is managed by the security administrator, and informing the user by e-mail",
      "Integrated enterprise resource management",
  ...
  },
  {
    "id": "q254",
    "source": "bank300",
    "question": "Which layer HTTP belongs TCP/IP?",
    "options": [
      "Overlap phases/activities",
      "Application",
      "Software as a Service",
  ...
  },
  {
    "id": "q258",
    "source": "bank300",
    "question": "Mail receive protocols?",
    "options": [
      "Sends requests on behalf of client",
      "Manual processing system",
      "POP/IMAP",
  ...
  },
  {
    "id": "q259",
    "source": "bank300",
    "question": "RAID with parity single disk?",
    "options": [
      "RAID 5",
      "Assemble/disassemble data, error control for transmission",
      "0.99",
  ...
  },
  {
    "id": "q260",
    "source": "bank300",
    "question": "Hot swap related often to?",
    "options": [
      "Outside independent party vs inside org",
      "Invention",
      "High availability hardware",
  ...
  },
  {
    "id": "q261",
    "source": "bank300",
    "question": "UPS supports which security aspect mainly?",
    "options": [
      "Quality Cost Delivery",
      "Availability (power)",
      "Add resources to shorten duration (cost↑)",
  ...
  },
  {
    "id": "q262",
    "source": "bank300",
    "question": "Clean desk policy is which measure type?",
    "options": [
      "0.99",
      "Encrypt session common key with public key, then symmetric encrypt data",
      "Human/organizational",
  ...
  },
  {
    "id": "q263",
    "source": "bank300",
    "question": "Lock on server room door?",
    "options": [
      "Estimate loss & frequency, rank risks",
      "O(1)",
      "No transitive dependency",
  ...
  },
  {
    "id": "q267",
    "source": "bank300",
    "question": "Digital certificate issued by?",
    "options": [
      "Programmable after manufacture",
      "CA (Certificate Authority)",
      "The sending log of the mail server can be protected from falsification.",
  ...
  },
  {
    "id": "q268",
    "source": "bank300",
    "question": "Symmetric algorithm example?",
    "options": [
      "Availability (power)",
      "AES",
      "SPOC for users",
  ...
  },
  {
    "id": "q276",
    "source": "bank300",
    "question": "Throughput high means?",
    "options": [
      "Behind schedule",
      "More jobs/transactions per time",
      "CA (Certificate Authority)",
  ...
  },
  {
    "id": "q277",
    "source": "bank300",
    "question": "Turnaround time used in?",
    "options": [
      "Batch job completion latency",
      "Map private/internal to external addresses",
      "MTBF/(MTBF+MTTR)",
  ...
  },
  {
    "id": "q278",
    "source": "bank300",
    "question": "Soft real-time miss deadline?",
    "options": [
      "Degraded quality, not necessarily fatal",
      "Reduce user errors, improve usability",
      "Entire source before execution",
  ...
  },
  {
    "id": "q283",
    "source": "bank300",
    "question": "Relationship cardinality M:N?",
    "options": [
      "Many-to-many",
      "Service Level Agreement with customer",
      "Seek + rotational latency + transfer",
  ...
  },
  {
    "id": "q291",
    "source": "bank300",
    "question": "Bus topology weakness?",
    "options": [
      "Expression of work / software code as work",
      "Utility software",
      "Shared medium / collision / cable fault impact",
  ...
  },
  {
    "id": "q292",
    "source": "bank300",
    "question": "Star topology center device often?",
    "options": [
      "Switch/hub",
      "Wireless LAN encryption/security method",
      "Configuration management database",
  ...
  },
  {
    "id": "q293",
    "source": "bank300",
    "question": "Optical fiber advantage?",
    "options": [
      "Manual processing system",
      "Physical security",
      "256",
  ...
  },
  {
    "id": "q294",
    "source": "bank300",
    "question": "Twisted pair common use?",
    "options": [
      "Throughput via pipelined frames",
      "Invention",
      "LAN Ethernet cabling",
  ...
  },
  {
    "id": "q297",
    "source": "bank300",
    "question": "Sliding window improves?",
    "options": [
      "BCP for IT services",
      "Prevent content leakage",
      "Throughput via pipelined frames",
