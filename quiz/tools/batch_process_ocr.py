...
print("Batch processing OCR for all cached images...")
...
for item in index_data:
    ...
    print(f"✓ Saved {task_id}.json ({updated_count}/{len(item['images'])} Qs updated)")

# Combine into hcm202.json and hcm202.js
all_qs = []
for item in index_data:
...
print(f"\n✅ COMPLETED BATCH OCR PROCESS! Total Qs: {len(all_qs)}")
