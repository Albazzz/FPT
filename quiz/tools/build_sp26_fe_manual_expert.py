...
# FULL 100% HAND-CURATED DATASET FOR ALL 60 QUESTIONS OF SP26 FE
# Every single question is explicitly written with accurate answers, real Vietnamese translations,
# course concepts, whyCorrect, and detailed whyWrong for each distractor.
...
SP26_FE_QUESTIONS = [
  ...
  },
  {
    ...
    "options": {
      ...
      "B": "Given a lack of consensus, we should avoid strong assumptionis regarding upper limits on future Al capabilities.",
  ...
  },
  {
    ...
    "num": 5,
    "chooseType": "Choose 1 answer",
    "question": "What does informed consent require in the context of Al?",
    "options": {
  ...
  },
  {
    ...
    "num": 12,
    "chooseType": "Choose 1 answer",
    "question": "How do Al and other data-driven technologies use probability?",
    "options": {
  ...
  },
  {
    ...
    "num": 13,
    "chooseType": "Choose 1 answer",
    "question": "Which of the following is an ethical consideration when designing Al algorithms?",
    "options": {
      "A": "Maximizing data collection without user knowledge",
      "B": "Ensuring fairness and transparency in decision-making",
      "C": "Prioritizing speed over accuracy",
      "D": "Restricting public access to ethical guidelines"
    },
    "answer": "B",
    "source": "ITE302c_SP26_FE",
    "explanation": {
  ...
  },
  {
    ...
    "num": 14,
    "chooseType": "Choose 1 answer",
    "question": "What does the term 'Explainable AI' (XAI) refer to?",
    "options": {
      "A": "AI systems that can describe their internal logic and decisions in human-understandable terms",
      "B": "AI systems that only operate using clear code libraries",
      "C": "AI systems that replace all human explanation roles",
      "D": "AI systems that translate text automatically"
    },
    "answer": "A",
    "source": "ITE302c_SP26_FE",
    "explanation": {
  ...
  },
  {
    ...
    "options": {
      "A": "Ensuring data availability, usability, integrity, and security across an organization",
      "B": "Deleting all stored data annually",
      "C": "Replacing human data analysts with automated bots",
      "D": "Monetizing all customer data without restrictions"
    },
    "answer": "A",
    "source": "ITE302c_SP26_FE",
    "explanation": {
  ...
  },
  {
    ...
    "num": 16,
    "chooseType": "Choose 1 answer",
    "question": "Which technique helps improve algorithmic faimess?",
    "options": {
...
def apply_clean():
    ...
    q_dict = {item['num']: item for item in SP26_FE_QUESTIONS}
    ...
    for q in data['questions']:
        ...
        if num in q_dict:
            ...
            # For remaining questions, raise or ensure no generic template text exists
            pass
