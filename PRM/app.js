/**
 * Quiz PRM392 – static quiz app (clone of MLN)
 * Exam filter: FE | FE-RE | both · multi-select · search · wrong bank
 */
(function () {
  "use strict";

  const STORAGE_KEY = "prm-quiz-wrong-ids-v1";
  const PROGRESS_KEY = "prm-quiz-progress-v1";
  ...
  function questionTag(q) {
    if (!q) return "";
    const lab = q.examLabel || (q.exam === "re" ? "FE-RE" : q.exam === "fe" ? "FE" : "");
